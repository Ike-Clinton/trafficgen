...
# GET Strings we send as ACK-GET payloads
getStr = "GET / HTTP/1.0\r\nHOST: web.epi.com\r\n\r\n"
...
while True:
	...
	rnd_src_ip = "" + str(RandNum(1, 254)) + "." + str(RandNum(0, 254)) + "." + str(RandNum(0, 254)) + "." + str(RandNum(1, 255)) 
	# Set up target IP and use spoofed source
	...
	port=RandNum(1024,65535)
	# Generate Random web traffic simulation to web.epi.com (192.168.20.20)
	rnd_src_ip = "" + str(RandNum(1, 254)) + "." + str(RandNum(0, 254)) + "." + str(RandNum(0, 254)) + "." + str(RandNum(1, 254)) 
	ip=IP(src=rnd_src_ip, dst=dst_ip)
	...
	for i in range(0, RandNum(10, 20)):
		...
		if num > 5:
			rnd_src_ip = "" + str(RandNum(1, 254)) + "." + str(RandNum(0, 254)) + "." + str(RandNum(0, 254)) + "." + str(RandNum(2, 254))
			res, unans = sr( IP(src= rnd_src_ip, dst=dst_ip)/TCP(flags='S', sport=port, dport=(3306)), timeout = 0.1)
			time.sleep(RandNum(0,1))
		...
		if num > 3:
			rnd_src_ip = "" + str(RandNum(1, 254)) + "." + str(RandNum(0, 254)) + "." + str(RandNum(0, 254)) + "." + str(RandNum(2, 254))
			res, unans = sr( IP(src= rnd_src_ip, dst=dst_ip)/TCP(flags='S', sport=port, dport=(22)), timeout = 0.1)
			time.sleep(RandNum(0,1))
